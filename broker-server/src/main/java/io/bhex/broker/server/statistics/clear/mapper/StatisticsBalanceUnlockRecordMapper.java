...
import io.bhex.broker.server.model.StatisticsBalanceUnlockRecord;
...
@Mapper
public interface StatisticsBalanceUnlockRecordMapper {


    @Select({"<script>"
            , "SELECT *"
            , "FROM ods_balance_unlock_record a "
            ...
            , "LIMIT #{limit} "
            , "</script>"})
    List<StatisticsBalanceUnlockRecord> queryBalanceUnlockRecordList(@Param("orgId") Long orgId,
